...
\cventry{Feb-Sept 2022, 2023 and 2024}{Teaching Assistent}{Mathematical methods for Physics}{University of Milan}{Milan}{I've had the opportunity to engage in tutoring roles, where I've not only imparted knowledge but also learned valuable lessons in communication, adaptability, and mentorship. I honed my ability to convey complex concepts clearly and tailor my approach to meet diverse student needs. The main topics of the course were: complex analysis, functional analysis, operator theory and the theory of distributions.}

\cventry{Sept 2022 and 2023}{Lecturer}{Introductory math}{University of Milan}{Milan}{Lecturer: Davide Morgante}
 
\section{Visiting}
\cventry{1 May - 15 June 2023}{Visiting PhD}{SISSA}{Trieste}{}{I was a visiting PhD student at the International School for Advanced Studies were I had to opportunity to follow the PhD courses provided by SISSA as well as discussing relevant topics with professors and students.}
...
\section{Schools}
\cventry{22-26 Apr 2024}{ICTP Spring School on Superstring Theory and Related Topics}{Trieste}{Italy}{}{
  Lectures:
  \begin{itemize}
    \item \textit{New AdS/CFT Entropy formulae at large charge and angular momentum} (Shiraz Minwalla)
    \item \textit{BFFS and BMN matrix models} (Shota Komatsu)
    \item \textit{The S-matrix bootstrap} (Alexander Zhiboedov)
    \item \textit{A celestial holography primer} (Andrea Puhm)
  \end{itemize}
}
...
\section{Seminars and Poster Presentations}
\cvitem{13 June 2024}{Poster presentation at \textbf{String Math 2024}, \href{https://indico.ictp.it/event/10482}{\textit{"Cardy Matches Bethe on the Surface: a Tale of a Brane and a Black Hole"}}, Trieste, Italy}
\cvitem{03 June 2024}{Poster presentation at \textbf{Strings 2024}, \href{https://indico.cern.ch/event/1284995/}{\textit{"BBBW On the Spindle"}}, Trieste, Italy}
\cvitem{21 May 2024}{Poster presentation at \textbf{Strings and Geometry 2024}, \href{https://sites.google.com/view/strings-and-geometry-2024/home?authuser=0}{\textit{"Cardy Matches Bethe on the Surface: a Tale of a Brane and a Black Hole"}}, Trieste, Italy}
\cvitem{22 Apr 2024}{Poster presentation at \textbf{Spring School on Superstring Theory and Related Topics}, \href{https://davidemorgante.github.io/files/seminars/ICTP.pdf}{\textit{"BBBW On the Spindle"}}, Trieste, Italy}
\cvitem{2 Nov 2023}{Invited talk at \textbf{Technion}, \href{https://davidemorgante.github.io/files/seminars/Technion.pdf}{\textit{"Spindly M5s"}}, Haifa, Israel.}
...
\cvitem{27 Sept 2022}{Talk at \textbf{Università degli Studi di Milano}, \href{https://davidemorgante.github.io/files/seminars/susy.pdf}{\textit{"Supersymmetric dualities in three-dimensions"}}, Milan, Italy.}
...
\cventry{2024}{\textbf{Cardy matches Bethe on the Surface: a Tale of a Brane and a Black Hole}}{\href{https://arxiv.org/abs/2403.17190}{ArXiv:2403.17190}}{Preprint}{}{A. Amariti, P. Glorioso, \underline{D. Morgante}, A. Zanetti}
...
\cvdoubleitem{Programming languages}{C, C++, Python, Mathematica, HTML, CSS}{Libraries:}{ROOT, Geant4, Scikit-learn, Tensorflow}
...
\fi
\section{Pesonal Interests}
\cventry{}{Music}{}{}{}{I've been teaching myself piano for as long as I can remember. It's not just about hitting the right notes, it's taught me the importance of sticking with something, even when it gets tough. Whether I'm tackling a tricky piece or a complex problem in my studies, I've learned the value of perseverance and focus.}
\cventry{}{DIY}{}{}{}{I'm passionate about hands-on projects, whether it's crafting wooden furniture or delving into DIY electronics. From designing and building intricate circuits to shaping wood into functional pieces, I enjoy the process of creating something tangible. These hobbies not only allow me to express my creativity but also teach me valuable lessons in problem-solving, precision, and perseverance.}


\section{References}
\begin{cvcolumns}
  \cvcolumn{Names }{\begin{itemize}\item Antonio Amariti \item Luca Guido Arthur Molinari\item Guido Martinelli\end{itemize}}
  \cvcolumn{E-mails}{
\begin{itemize}
    \item antonio.amariti@mi.infn.it
    \item luca.molinari@mi.infn.it
